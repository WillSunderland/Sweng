    ...
    <footer className="py-8 px-10 border-t" style={{ background: 'var(--card-bg)', borderColor: 'var(--border-light)' }}>
      <div className="max-w-[1200px] mx-auto flex justify-between items-center">
        ...
        <div className="flex gap-4">
          <a href="https://www.linkedin.com/company/rws-group/" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg flex items-center justify-center no-underline transition-all"
          ...
          <a href="https://www.rws.com/" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg flex items-center justify-center no-underline transition-all"
            style={{ background: 'var(--bg-light)', color: 'var(--text-body)' }}>
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
