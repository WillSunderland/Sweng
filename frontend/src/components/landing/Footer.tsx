...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-white border-t border-slate-200 py-8 px-10">
      <div className="max-w-[1200px] mx-auto flex justify-between items-center">
        <div className="flex-shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-semibold text-lg text-slate-900" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              Propylon
            </span>
          </div>
        </div>
      ...
      <div className="max-w-[1200px] mx-auto mt-6 pt-6 border-t border-slate-200 text-center text-[13px] text-slate-400">
